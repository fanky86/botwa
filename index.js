...
try{
		...
		if (update.connection == "open" || update.receivedPendingNotifications == "true") {
	        ...
	        console.log(color(`\n${themeemoji} YT CHANNEL: fanky86`,'magenta'))
            console.log(color(`${themeemoji} GITHUB: Rudal-XD `,'magenta'))
            console.log(color(`${themeemoji} INSTAGRAM: @fanky_a7 `,'magenta'))
